...
<html lang="en">
  <head>
    ...
    <style>
      body {
        background-image: url('IMAGE/Dashboard2.avif'); /* Set your background image */
      ...
      .card-3 {
        background-image: url('IMAGE/Card 3.avif'); /* Background for Card 3 */
        background-size: cover;
        background-position: center;
      }

      .card-4 {
        background-image: url('IMAGE/Card 4.avif'); /* Background for Card 4 */
        background-size: cover;
        background-position: center;
      }
		.card-5 {
        background-image: url('IMAGE/Card 5.webp'); /* Background for Card 1 */
        background-size: cover;
        background-position: center;
      }
      ...
      .card:hover {
        ...
        box-shadow: 0 8px 16px rgba(255, 255, 255, 0.8); /* Darker black shadow on hover */
      }
    </style>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container-fluid">
        ...
        <a class="navbar-brand d-flex align-items-center" href="#">
          <img src="IMAGE/landing side 1.jpeg" alt="Logo" style="height: 30px; width: 30px; margin-right: 10px;"> <!-- Adjust image path and size -->
          Admin Dashboard
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link" onclick="window.location.href='AdminLogout';">Logout</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="card-container">
      <div class="card card-0" onclick="window.location.href='Memberslist';">
        Members Details
      </div>
      <!-- Card 1 -->
      <div class="card card-1" onclick="window.location.href='Reservationlist';">
        Reservations
      </div>
      <!-- Card 2 -->
      <div class="card card-2" onclick="window.location.href='CancelReservation';">
        Cancel Reservation
      </div>
      <!-- Card 3 -->
      <div class="card card-3" onclick="window.location.href='AddUser';">
        Add User
      </div>
      <!-- Card 4 -->
      <div class="card card-4" onclick="window.location.href='DeleteUser';">
        Delete User
      </div>
      <div class="card card-5" onclick="window.location.href='Updatepassword';">
        Update Password
      </div>
    </div>
